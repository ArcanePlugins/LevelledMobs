...
public class NamespacedKeys {
    ...
    public static final NamespacedKey OVERRIDDEN_ENTITY_NAME_KEY = new NamespacedKey(MAIN, "overriden-entity-name");
    public static final NamespacedKey PLAYER_LEVELLING_ID_KEY = new NamespacedKey(MAIN, "player-levelling-id");
    public static final NamespacedKey CHANCE_RULE_ALLOWED_KEY = new NamespacedKey(MAIN, "chance-rule-allowed");
    public static final NamespacedKey CHANCE_RULE_DENIED_KEY = new NamespacedKey(MAIN, "chance-rule-denied");
    public static final NamespacedKey NAMETAG_FORMAT_KEY = new NamespacedKey(MAIN, "nametag-format");
    public static final NamespacedKey MAJOR_PLUGIN_VERSION_KEY = new NamespacedKey(MAIN, "major-plugin-version");
