...
public final class MobData {
    ...
    public static Optional<String> getSpawnReason(final LivingEntity entity) {
        return Optional.ofNullable(
            getPDC(entity).get(NamespacedKeys.SPAWN_REASON_KEY, PersistentDataType.STRING));
    }

    public static Optional<String> getWasBabyMob(final LivingEntity entity) {
        return Optional.ofNullable(
            getPDC(entity).get(NamespacedKeys.WAS_BABY_MOB_KEY, PersistentDataType.STRING));
    }

    public static Optional<String> getOverriddenEntityName(final LivingEntity entity) {
        return Optional.ofNullable(getPDC(entity).get(NamespacedKeys.OVERRIDDEN_ENTITY_NAME_KEY,
            PersistentDataType.STRING));
    }

    @Deprecated
    public static void setOverriddenEntityName(final LivingEntity entity, final String val) {
        getPDC(entity).set(NamespacedKeys.OVERRIDDEN_ENTITY_NAME_KEY, PersistentDataType.STRING,
            val);
    }

    public static Optional<String> getPlayerLevellingId(final LivingEntity entity) {
        return Optional.ofNullable(
            getPDC(entity).get(NamespacedKeys.PLAYER_LEVELLING_ID_KEY, PersistentDataType.STRING));
    }

    public static Optional<Double> getChanceRuleAllowed(final LivingEntity entity) {
        return Optional.ofNullable(
            getPDC(entity).get(NamespacedKeys.CHANCE_RULE_ALLOWED_KEY, PersistentDataType.DOUBLE));
    }

    public static Optional<Double> getChanceRuleDenied(final LivingEntity entity) {
        return Optional.ofNullable(
            getPDC(entity).get(NamespacedKeys.CHANCE_RULE_DENIED_KEY, PersistentDataType.DOUBLE));
    }

    public static Optional<String> getNametagFormat(final LivingEntity entity) {
        return Optional.ofNullable(
            getPDC(entity).get(NamespacedKeys.NAMETAG_FORMAT_KEY, PersistentDataType.STRING));
    }
