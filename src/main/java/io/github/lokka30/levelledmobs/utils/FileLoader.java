...
public final class FileLoader {
    ...
    private static void checkFileVersion(File file, int compatibleVersion, int installedVersion) {
        ...
        if (installedVersion < compatibleVersion) {
            Utils.logger.error("&fFile Loader: &7The version of &b" + file.getName() + "&7 you have installed is outdated! Fix this as soon as possible, else the plugin will most likely malfunction.");
        } else {
            Utils.logger.error("&fFile Loader: &7The version of &b" + file.getName() + "&7 you have installed is ahead of the compatible version of this file for this version of the plugin! Fix this as soon as possible, else the plugin will most likely malfunction.");
        }
