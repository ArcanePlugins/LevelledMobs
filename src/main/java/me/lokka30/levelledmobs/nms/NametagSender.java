...
public class NametagSender implements NMSUtil {
    ...
    public void sendNametag(final @NotNull LivingEntity livingEntity, @Nullable String nametag, @NotNull Player player, final boolean doAlwaysVisible) {
        ...
        try {
            final Class<?> clazz_CraftLivingEntity = Class.forName("org.bukkit.craftbukkit." + nmsVersion + ".entity.CraftLivingEntity");
            final Method method_getHandle = clazz_CraftLivingEntity.getDeclaredMethod("getHandle");
            final net.minecraft.world.entity.LivingEntity internalLivingEntity = (net.minecraft.world.entity.LivingEntity) method_getHandle.invoke(livingEntity);
            ...
            final Class<?> clazz_CraftChatMessage = Class.forName("org.bukkit.craftbukkit." + nmsVersion + ".util.CraftChatMessage");
            final Method method_fromString = clazz_CraftChatMessage.getDeclaredMethod("fromString", String.class);
            // components = org.bukkit.craftbukkit.v1_18_R1.util.CraftChatMessage.fromString(nametag);
            final Component[] components = (Component[]) method_fromString.invoke(clazz_CraftChatMessage, nametag);
            ...
            final Class<?> clazz_CraftPlayer = Class.forName("org.bukkit.craftbukkit." + nmsVersion + ".entity.CraftPlayer");
