...
public class DebugSubcommand extends MessagesBase implements Subcommand {
    ...
    private void doNbtDump(final @NotNull CommandSender sender, final String @NotNull [] args){
        ...
        final LivingEntityWrapper lmEntity = main.levelledMobsCommand.rulesSubcommand.getMobBeingLookedAt(player, true);
        if (lmEntity == null){
    ...
    private void chunkKillCount(final @NotNull CommandSender sender, final String @NotNull [] args){
