 ...
 * Plugin:     AureliumMobs
 * Author:     OfTeN
 * Link:       https://www.spigotmc.org/resources/aureliummobs.94168/
 */
public class AureliumMobsIntegration implements Integration, MobOwner {

    @Override
    public boolean isInstalled() {
        return Bukkit.getPluginManager().isPluginEnabled("AureliumMobs");
    }
