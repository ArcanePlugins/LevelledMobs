...
public class AddDropTablesAction extends Action {

    private final Set<String> dropTablesToAdd = new HashSet<>();

    public AddDropTablesAction(
    ...
    public void run(
        ...
        final Set<String> dropTables = new HashSet<>(getDropTablesToAdd());
        dropTables.addAll(InternalEntityDataUtil.getDropTableIds(lentity));
        InternalEntityDataUtil.setDropTableIds(lentity, dropTables);
    }

    public @NotNull Set<String> getDropTablesToAdd() {
        return dropTablesToAdd;
    }
}
